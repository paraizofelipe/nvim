...
local icons = {locker = ' ', unsaved = ' ', dos = ' ', unix = '', mac = '', lsp_error = ' ', lsp_warn = ' '}
...
gls.left[6] = {DiffAdd = {provider = 'DiffAdd', condition = checkwidth, icon = ' ', highlight = {colors.green, colors.bg}}}
gls.left[7] = {DiffModified = {provider = 'DiffModified', condition = checkwidth, icon = ' ', highlight = {colors.orange, colors.bg}}}
gls.left[8] = {DiffRemove = {provider = 'DiffRemove', condition = checkwidth, icon = ' ', highlight = {colors.red, colors.bg}}}
...
gls.left[12] = {
    DiagnosticError = {provider = 'DiagnosticError', icon = '  ', highlight = {colors.red, colors.bg}, condition = condition.check_active_lsp}
}

gls.left[13] = {
    DiagnosticWarn = {provider = 'DiagnosticWarn', icon = '  ', highlight = {colors.blue, colors.bg}, condition = condition.check_active_lsp}
}

gls.right[1] = {
    FileEncode = {provider = 'FileEncode', separator = '', separator_highlight = {colors.gray, colors.bg}, highlight = {colors.dark, colors.gray}}
}
...
gls.right[3] = {
    LineInfo = {provider = 'LineColumn', separator = '  ', separator_highlight = {colors.bg, colors.gray}, highlight = {colors.dark, colors.gray}}
}
gls.right[4] = {
    PerCent = {provider = 'LinePercent', separator = ' ', separator_highlight = {colors.bg02, colors.gray}, highlight = {colors.gray, colors.bg02}}
}
gls.right[5] = {ScrollBar = {provider = 'ScrollBar', highlight = {colors.yellow, colors.bg02}}}
